...
class KX_NULL(_GenericKX):
    ...
    def server_kx_msg_cls(_, m): return None
...
class KX_DHE_RSA(_GenericKX):
    ...
    def server_kx_msg_cls(_, m): return ServerDHParams
...
class KX_ECDHE_RSA(_GenericKX):
    ...
    def server_kx_msg_cls(_, m): return _tls_server_ecdh_cls_guess(m)
...
class KX_RSA_EXPORT(KX_RSA):
    ...
    def server_kx_msg_cls(_, m): return ServerRSAParams
