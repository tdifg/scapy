...
class ISIS_ExtendedIpPrefix(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(FieldLenField("subtlvslen", None, length_of="subtlvs",
                                       fmt="B"), lambda pkt: pkt.subtlvindicator == 1),
        ConditionalField(PacketListField("subtlvs", [], _ISIS_GuessSubTlvClass_2,
...
class ISIS_ExtendedIsNeighbourEntry(Packet):
    ...
    fields_desc = [
        ...
        PacketListField("subtlvs", [], _ISIS_GuessSubTlvClass_1,
